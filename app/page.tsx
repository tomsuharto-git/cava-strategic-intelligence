        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              CAVA operates <strong>415 Mediterranean fast-casual restaurants</strong> generating <strong>$1.2B+ revenue</strong> with <strong>24.6% restaurant-level margins</strong>. The company delivered <strong>1.9% same-store sales growth</strong> in Q3 2025 with <strong>flat traffic</strong>, outperforming industry traffic decline of 3.3%. New 2025 units are tracking above <strong>$3M average unit volumes</strong> with 100%+ productivity, validating the concept's portability beyond core markets. However, brand awareness remains the primary constraint: <strong>67% in mature markets</strong> (DC/MD/VA) versus 90% for established competitors, dropping to <strong>40% in new geographies</strong>. The Mediterranean fast-casual category ($14.2B, 10.8% CAGR) currently has no scaled national competitor, creating opportunity for category leadership through aggressive unit growth and brand-building investment.
            </p>
